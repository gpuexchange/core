...
class Transaction {
    ...
    static copy(o) {
        ...
        const truncatedStartHash = new Uint8Array(o._truncatedStartHash);
    ...
    equals(o) {
        return o instanceof Transaction
            ...
            && this._fee === o._fee
            && this._validityStartHeight.equals(o._validityStartHeight)
            && BufferUtils.equals(this._truncatedStartHash, o._truncatedStartHash)
    ...
    toString() {
        return `Transaction{`
            ...
            + `truncatedStartHash=${this._truncatedStartHash}`
            + `}`;
    }
    ...
    /** @type {Uint8Array} */
    get truncatedStartHash() {
        return this._truncatedStartHash;
    }
